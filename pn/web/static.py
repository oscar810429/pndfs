...
# Sibling Imports
from pn.web import http_headers, resource
from pn.web import http, iweb, responsecode, server, dirlist
from pn.core import stream
...
if __name__ == '__builtin__':
    ...
    res = File('/')
    application = service.Application("/home/zhangsf/")
