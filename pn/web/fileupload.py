...
from pn.core.stream import IStream, FileStream, BufferedStream, readStream
from pn.core.stream import generatorToStream, readAndDiscard
...
if __name__ == '__main__':
    d = parseMultipartFormData(
        FileStream(open("/users/zhangsf/big.jpg")), "----------0xKhTmLbOuNdArY")
